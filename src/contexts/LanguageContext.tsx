...
const translations = {
  ...
  en: {
    ...
    'community.stats.totalProjects': 'Registered Game Posts',
  ...
  es: {
    ...
    'community.posts.title': 'Experimenta Comunidades de Juegos Globales en Tu Idioma',
    'community.posts.subtitle': 'MeanWhile resume y traduce datos de comunidades gaming globales con IA, compartiéndolos en Discord.',
